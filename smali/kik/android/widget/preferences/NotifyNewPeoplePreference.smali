...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lkik/android/widget/preferences/KikCheckBoxPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILcom/kik/b/b/a$c;)V
...
.method private b(Z)V
    ...
    .line 61
    iget-object v0, p0, Lkik/android/widget/preferences/NotifyNewPeoplePreference;->b:Lkik/a/d/t;

    invoke-interface {v0, p1}, Lkik/a/d/t;->a(Z)Lcom/kik/e/p;
    ...
    new-instance v2, Lkik/android/widget/preferences/ar;

    invoke-direct {v2, p0, p1}, Lkik/android/widget/preferences/ar;-><init>(Lkik/android/widget/preferences/NotifyNewPeoplePreference;Z)V
    ...
    .line 89
    new-instance v1, Lkik/android/widget/preferences/as;

    invoke-direct {v1, p0}, Lkik/android/widget/preferences/as;-><init>(Lkik/android/widget/preferences/NotifyNewPeoplePreference;)V
...
.method public final a(Lcom/kik/c/a;)V
    ...
    .prologue
    .line 46
    invoke-interface {p1, p0}, Lcom/kik/c/a;->a(Lkik/android/widget/preferences/NotifyNewPeoplePreference;)V
...
.method protected onCreateView(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 53
    iget-object v1, p0, Lkik/android/widget/preferences/NotifyNewPeoplePreference;->b:Lkik/a/d/t;

    invoke-interface {v1}, Lkik/a/d/t;->d()Lkik/a/c/w;

    move-result-object v1

    iget-object v1, v1, Lkik/a/c/w;->h:Ljava/lang/Boolean;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    new-instance v5, Lkik/android/widget/preferences/av;

    invoke-direct {v5, p0}, Lkik/android/widget/preferences/av;-><init>(Lkik/android/widget/preferences/NotifyNewPeoplePreference;)V
    ...
    new-instance v5, Lkik/android/widget/preferences/au;

    invoke-direct {v5, p0, v0}, Lkik/android/widget/preferences/au;-><init>(Lkik/android/widget/preferences/NotifyNewPeoplePreference;Z)V
    ...
    new-instance v3, Lkik/android/widget/preferences/at;

    invoke-direct {v3, p0, p1}, Lkik/android/widget/preferences/at;-><init>(Lkik/android/widget/preferences/NotifyNewPeoplePreference;Landroid/preference/Preference;)V
